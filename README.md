...
| [`barte-fde-setup`](plugins/barte-fde-setup) | takes a new FDE or Client Partner's machine from zero to working, and **runs** the setup instead of handing over a list of commands — `assets/doctor.sh` reports what is still missing |
